...
Acknowledgements
-----------------
serial_xds was developt at Cornell High Energy Synchrotron Source (CHESS) for serial ossilation crystallography data processing at MacCHESS ID7B2 beamline.
